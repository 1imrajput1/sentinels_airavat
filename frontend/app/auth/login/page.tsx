        ...
        >
          <div className="p-8">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-[#07a6ec]">Login</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-[#07a6ec] hover:text-[#0596d3]">
                    Forgot password?
                  </a>
                </div>
              </div>
            ...
            <div className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link href="/auth/signup" className="font-semibold text-[#fa6724] hover:text-[#e05a1a]">
                Sign Up
              </Link>
            </div>
          </div>
